                                                    ...
                                                    <li class="lk" style="cursor: pointer"
                                                        ...
                                                        <div class="d-flex bd-highlight">
                                                            <div class="img_cont">
                                                                ...
                                                                <span @if(in_array($friend->id,$onlines)) class="online_icon" @else
                                                                class="offline_icon"@endif></span>
                                                            </div>
                                                            <div class="user_info">
                                    ...
                                    <div class="card" v-if="conversation_show">
                                        <div class="card-header msg_head">
                                            <div class="d-flex bd-highlight">
                                                ...
                                                <div class="video_cam">
                                                    <span v-on:click="video(friend.id)"><i class="fas fa-video"></i></span>
                                                </div>
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#student-nav-inbox').addClass('active')
