!function (e, t) {
    ...
    var V = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        h = function (e, t) {
            ...
            var e = w();
            return n(e.querySelectorAll("." + I.icon))
        }, k = function () {
            return y(I.title)
        }, x = function () {
            return y(I.content)
            ...
            var e = n(w().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function (e, t) {
                    return e = parseInt(e.getAttribute("tabindex")), (t = parseInt(t.getAttribute("tabindex"))) < e ? 1 : e < t ? -1 : 0
                }),
                t = n(w().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]')).filter(function (e) {
        ...
        Z = function (e) {
            var t = b();
            if (t && (t.parentNode.removeChild(t), v([document.documentElement, document.body], [I["no-backdrop"], I["toast-shown"], I["has-column"]])), !j()) {
                ...
                var o = w(), r = x(), i = N(r, I.input), a = N(r, I.file),
                    s = r.querySelector("." + I.range + " input"), u = r.querySelector("." + I.range + " output"),
                    c = N(r, I.select), l = r.querySelector("." + I.checkbox + " input"), d = N(r, I.textarea);
            ...
            if (!e) return z(t);
            if ("object" === (void 0 === e ? "undefined" : V(e))) if (t.innerHTML = "", 0 in e) for (var n = 0; n in e; n++) t.appendChild(e[n].cloneNode(!0)); else t.appendChild(e.cloneNode(!0)); else e && (t.innerHTML = e);
            W(t)
        }, Y = function () {
            if (j()) return !1;
            ...
            } else v([r, i], I.styled), r.style.backgroundColor = r.style.borderLeftColor = r.style.borderRightColor = "", i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = ""
        }, J = function (e) {
            var t = x().querySelector("#" + I.content);
            e.html ? Q(e.html, t) : e.text ? (t.textContent = e.text, W(t)) : z(t)
        }, X = function (e) {
            for (var t = C(), n = 0; n < t.length; n++) z(t[n]);
            if (e.type) if (-1 !== Object.keys(f).indexOf(e.type)) {
                var o = Ee.getPopup().querySelector("." + I.icon + "." + f[e.type]);
                W(o), e.animation && R(o, "swal2-animate-" + e.type + "-icon")
            } else q('Unknown type! Expected "success", "error", "warning", "info" or "question", got "' + e.type + '"')
        }, G = function (e) {
            var t = B();
            e.imageUrl ? (t.setAttribute("src", e.imageUrl), t.setAttribute("alt", e.imageAlt), W(t), e.imageWidth ? t.setAttribute("width", e.imageWidth) : t.removeAttribute("width"), e.imageHeight ? t.setAttribute("height", e.imageHeight) : t.removeAttribute("height"), t.className = I.image, e.imageClass && R(t, e.imageClass)) : z(t)
        }, ee = function (r) {
            var i = A(), a = parseInt(null === r.currentProgressStep ? Ee.getQueueStep() : r.currentProgressStep, 10);
            r.progressSteps && r.progressSteps.length ? (W(i), i.innerHTML = "", a >= r.progressSteps.length && d("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), r.progressSteps.forEach(function (e, t) {
            ...
            var o = b(), t = w();
            if (t) {
                null !== e && "function" == typeof e && e(t), v(t, I.show), R(t, I.hide);
                var r = function () {
                    var e, t;
                    T() || (e = window.scrollX, t = window.scrollY, oe.restoreFocusTimeout = setTimeout(function () {
                        oe.previousActiveElement && oe.previousActiveElement.focus && (oe.previousActiveElement.focus(), oe.previousActiveElement = null)
                    }, 100), void 0 !== e && void 0 !== t && window.scrollTo(e, t), oe.keydownTarget.removeEventListener("keydown", oe.keydownHandler, {capture: oe.keydownListenerCapture}), oe.keydownHandlerAdded = !1), o.parentNode && o.parentNode.removeChild(o), v([document.documentElement, document.body], [I.shown, I["height-auto"], I["no-backdrop"], I["toast-shown"], I["toast-column"]]), L() && (null !== m.previousBodyPadding && (document.body.style.paddingRight = m.previousBodyPadding, m.previousBodyPadding = null), function () {
                        if (h(document.body, I.iosfix)) {
                            var e = parseInt(document.body.style.top, 10);
                            v(document.body, I.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e
                        }
    ...
    var ae = {
            ...
            for (var t in e) ue(t) || d('Unknown parameter "' + t + '"'), ce(t) && l('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
        },
    ...
    var fe = [], me = function () {
            ...
            e || Ee(""), e = w();
            var t = E(), n = P(), o = S();
            W(t), W(n), R([e, t], I.loading), n.disabled = !0, o.disabled = !0, e.setAttribute("data-loading", !0), e.setAttribute("aria-busy", !0), e.focus()
        }, he = Object.freeze({
            isValidParameter: ue,
                        ...
                        ["title", "html", "type"].forEach(function (e, t) {
                            switch (V(n[t])) {
                                ...
                                case"undefined":
                                    break;
                                default:
                                    q("Unexpected type of " + e + '! Expected "string", got ' + V(n[t]))
                            }
                        });
                        break;
                    case"object":
                        ...
                        break;
                    default:
                        q('Unexpected type of argument! Expected "string" or "object", got "' + V(n[0]) + '"')
                }
                return o
            },
            ...
            getButtonsWrapper: function () {
                return l("swal.getButtonsWrapper() is deprecated and will be removed in the next major release, use swal.getActions() instead"), y(I.actions)
            },
            getActions: E,
            getConfirmButton: P,
            getCancelButton: S,
        ...
        be = {promise: new ve, innerParams: new ve, domCache: new ve};

    function ye() {
        var e = be.innerParams.get(this), t = be.domCache.get(this);
        e.showConfirmButton || (z(t.confirmButton), e.showCancelButton || z(t.actions)), v([t.popup, t.actions], I.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.cancelButton.disabled = !1
    }
    ...
    var ke = function (e) {
        var t = b(), n = w();
        null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n), e.animation ? (R(n, I.show), R(t, I.fade), v(n, I.hide)) : v(n, I.fade), W(n), t.style.overflowY = "hidden", Y && !h(n, I.noanimation) ? n.addEventListener(Y, function e() {
    ...
    var xe = Object.freeze({
        hideLoading: ye, disableLoading: ye, getInput: function (e) {
            ...
            var e = be.domCache.get(this);
            e.validationError && z(e.validationError);
            var t = this.getInput();
            ...
            var t = be.innerParams.get(this), n = r({}, t, {progressSteps: e});
            be.innerParams.set(this, n), ee(n)
            ...
            !function (t) {
                ...
                var e = void 0, n = w(), o = "string" == typeof t.target ? document.querySelector(t.target) : t.target;
                ...
                var s = b(), u = F(), c = O();
                if (te(t), J(t), "string" == typeof t.backdrop ? b().style.background = t.backdrop : t.backdrop || R([document.documentElement, document.body], I["no-backdrop"]), t.position in I ? R(s, I[t.position]) : (d('The "position" parameter is not valid, defaulting to "center"'), R(s, I.center)), t.grow && "string" == typeof t.grow) {
                    var l = "grow-" + t.grow;
                    l in I && R(s, I[l])
                }
                "function" == typeof t.animation && (t.animation = t.animation.call()), t.showCloseButton ? (u.setAttribute("aria-label", t.closeButtonAriaLabel), W(u)) : z(u), e.className = I.popup, t.toast ? (R([document.documentElement, document.body], I["toast-shown"]), R(e, I.toast)) : R(e, I.modal), t.customClass && R(e, t.customClass), ee(t), X(t), G(t), $(t), Q(t.footer, c), !0 === t.animation ? v(e, I.noanimation) : R(e, I.noanimation), t.showLoaderOnConfirm && !t.preConfirm && d("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")
            }(T), Object.freeze(T), be.innerParams.set(this, T), oe.timeout && (oe.timeout.stop(), delete oe.timeout), clearTimeout(oe.restoreFocusTimeout);
            var j = {
                popup: w(),
                container: b(),
                content: x(),
                ...
                cancelButton: S(),
                closeButton: F(),
                validationError: y(I.validationerror),
                progressSteps: A()
            };
            ...
            return new Promise(function (t, n) {
                ...
                for (var d = function (t) {
                    if (T.showLoaderOnConfirm && _.showLoading(), T.preConfirm) {
                        ...
                        T.expectRejections ? e.then(function (e) {
                            ...
                            U(j.validationError) || !1 === e ? L.hideLoading() : o(e || t)
                        }, function (e) {
                            return l(e)
                        })
                    } else o(t)
                }, e = function (e) {
                    var t = e || window.event, n = t.target || t.srcElement, o = j.confirmButton, r = j.cancelButton,
                        i = o && (o === n || o.contains(n)), a = r && (r === n || r.contains(n));
                    switch (t.type) {
                        case"click":
                            if (i && _.isVisible()) if (L.disableButtons(), T.input) {
                                var s = function () {
                                    var e = L.getInput();
                                    if (!e) return null;
                                    switch (T.input) {
                                ...
                                if (T.inputValidator) {
                                    ...
                                    var u = Promise.resolve().then(function () {
                                        return T.inputValidator(s, T.extraParams)
                                    });
                                    T.expectRejections ? u.then(function () {
                                        L.enableButtons(), L.enableInput(), d(s)
                                    }, function (e) {
                                        L.enableButtons(), L.enableInput(), e && L.showValidationError(e)
                                    }) : u.then(function (e) {
                                        L.enableButtons(), L.enableInput(), e ? L.showValidationError(e) : d(s)
                                    }, function (e) {
                                        return l(e)
                                    })
                                } else d(s)
                            } else d(!0); else a && _.isVisible() && (L.disableButtons(), c(_.DismissReason.cancel))
                    }
                ...
                if (j.closeButton.onclick = function () {
                    ...
                    T.showConfirmButton || T.showCancelButton || T.showCloseButton || T.input || c(_.DismissReason.close)
                }; else {
                    var a = !1;
                    j.popup.onmousedown = function () {
                        ...
                        a ? a = !1 : e.target === j.container && M(T.allowOutsideClick) && c(_.DismissReason.backdrop)
                    }
                }
                ...
                oe.keydownHandlerAdded && (oe.keydownTarget.removeEventListener("keydown", oe.keydownHandler, {capture: oe.keydownListenerCapture}), oe.keydownHandlerAdded = !1), T.toast || (oe.keydownHandler = function (e) {
                    return function (e, t) {
                        if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                            for (var n = e.target || e.srcElement, o = K(t.focusCancel), r = -1, i = 0; i < o.length; i++) if (n === o[i]) {
                                r = i;
                                break
                            }
                            e.shiftKey ? s(r, -1) : s(r, 1), e.stopPropagation(), e.preventDefault()
                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === j.confirmButton && U(j.cancelButton) ? j.cancelButton.focus() : document.activeElement === j.cancelButton && U(j.confirmButton) && j.confirmButton.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== M(t.allowEscapeKey) || c(_.DismissReason.esc); else if (e.target && L.getInput() && e.target.outerHTML === L.getInput().outerHTML) {
                            if (-1 !== ["textarea", "file"].indexOf(t.input)) return;
                            _.clickConfirm(), e.preventDefault()
                        }
                    }(e, T)
                }, oe.keydownTarget = T.keydownListenerCapture ? window : j.popup, oe.keydownListenerCapture = T.keydownListenerCapture, oe.keydownTarget.addEventListener("keydown", oe.keydownHandler, {capture: oe.keydownListenerCapture}), oe.keydownHandlerAdded = !0), L.enableButtons(), L.hideLoading(), L.resetValidationError(), (T.input || T.footer || T.showCloseButton) && R(document.body, I["toast-column"]);
                for (var u = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], p = void 0, f = 0; f < u.length; f++) {
                    var m = I[u[f]], h = N(j.content, m);
                    if (p = L.getInput(u[f])) {
                        for (var g in p.attributes) if (p.attributes.hasOwnProperty(g)) {
                            var v = p.attributes[g].name;
                            "type" !== v && "value" !== v && p.removeAttribute(v)
                        }
                        for (var b in T.inputAttributes) p.setAttribute(b, T.inputAttributes[b])
                    }
                    h.className = m, T.inputClass && R(h, T.inputClass), z(h)
                }
                var y = void 0;
                switch (T.input) {
                    case"text":
                    ...
                    case"tel":
                    case"url":
                        (p = N(j.content, I.input)).value = T.inputValue, p.placeholder = T.inputPlaceholder, p.type = T.input, W(p);
                        break;
                    case"file":
                        (p = N(j.content, I.file)).placeholder = T.inputPlaceholder, p.type = T.input, W(p);
                        break;
                    case"range":
                        var w = N(j.content, I.range), C = w.querySelector("input"), k = w.querySelector("output");
                        C.value = T.inputValue, C.type = T.input, k.value = T.inputValue, W(w);
                        break;
                    case"select":
                        var x = N(j.content, I.select);
                        if (x.innerHTML = "", T.inputPlaceholder) {
                            var B = document.createElement("option");
                            B.innerHTML = T.inputPlaceholder, B.value = "", B.disabled = !0, B.selected = !0, x.appendChild(B)
                        }
                        y = function (e) {
                    ...
                    case"radio":
                        ...
                        A.innerHTML = "", y = function (e) {
                            e.forEach(function (e) {
                                ...
                                i.innerHTML = n, i.className = I.label, r.appendChild(o), r.appendChild(i), A.appendChild(r)
                            }), W(A);
                        ...
                        break;
                    case"checkbox":
                        var P = N(j.content, I.checkbox), S = L.getInput("checkbox");
                        S.type = "checkbox", S.value = 1, S.id = I.checkbox, S.checked = Boolean(T.inputValue), P.querySelector("span").innerHTML = T.inputPlaceholder, W(P);
                        break;
                    case"textarea":
                        var E = N(j.content, I.textarea);
                        E.value = T.inputValue, E.placeholder = T.inputPlaceholder, W(E);
                        break;
                    case null:
                        break;
                    default:
                        q('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "' + T.input + '"')
                }
                if ("select" === T.input || "radio" === T.input) {
                    ...
                    H(T.inputOptions) ? (_.showLoading(), T.inputOptions.then(function (e) {
                        L.hideLoading(), O(e)
                    })) : "object" === V(T.inputOptions) ? O(T.inputOptions) : q("Unexpected type of inputOptions! Expected object, Map or Promise, got " + V(T.inputOptions))
                } else -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(T.input) && H(T.inputValue) && (_.showLoading(), z(p), T.inputValue.then(function (e) {
                    p.value = "number" === T.input ? parseFloat(e) || 0 : e + "", W(p), p.focus(), L.hideLoading()
                }).catch(function (e) {
                    q("Error in inputValue promise: " + e), p.value = "", W(p), p.focus(), L.hideLoading()
                }));
                ke(T), T.toast || (M(T.allowEnterKey) ? T.focusCancel && U(j.cancelButton) ? j.cancelButton.focus() : T.focusConfirm && U(j.confirmButton) ? j.confirmButton.focus() : s(-1, 1) : document.activeElement && document.activeElement.blur()), j.container.scrollTop = 0
            })
        }
    }), Be = void 0;
    ...
    function Ae() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && q("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)");
            for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n];
            if (void 0 === t[0]) return q("At least 1 argument is expected!"), !1;
            Be = this;
            var o = Object.freeze(this.constructor.argsToParams(t));
            Object.defineProperties(this, {params: {value: o, writable: !1, enumerable: !0}});
            var r = this._main(this.params);
            be.promise.set(this, r)
        }
    }

    Ae.prototype.then = function (e, t) {
        return be.promise.get(this).then(e, t)
    }, Ae.prototype.catch = function (e) {
        return be.promise.get(this).catch(e)
    }, Ae.prototype.finally = function (e) {
        return be.promise.get(this).finally(e)
    }, r(Ae.prototype, xe), r(Ae, he), Object.keys(xe).forEach(function (t) {
        Ae[t] = function () {
            var e;
            if (Be) return (e = Be)[t].apply(e, arguments)
        }
    }), Ae.DismissReason = e, Ae.noop = function () {
    }, Ae.version = "7.26.3";
    var Pe, Se, Ee = ie((Pe = Ae, Se = function (e) {
        function t() {
            return s(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
        }
        ...
        return a(t, Pe), o(t, [{
            ...
            key: "setDefaults", value: function (t) {
                if (l(de), !t || "object" !== (void 0 === t ? "undefined" : V(t))) throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");
    ...
    }(), "undefined" != typeof window && "object" === V(window._swalDefaults) && Se.setDefaults(window._swalDefaults), Se));
